        ...
        private void listBox1_DrawItem(object sender, DrawItemEventArgs e)
        {
            if (e.Index >= 0)
            {
                ...
                if (listBox1.Items[e.Index].ToString().Contains("武器箱") || listBox1.Items[e.Index].ToString().Contains("上衣箱") || listBox1.Items[e.Index].ToString().Contains("下衣箱") || listBox1.Items[e.Index].ToString().Contains("手套箱") || listBox1.Items[e.Index].ToString().Contains("鞋子箱")
                    || listBox1.Items[e.Index].ToString().Contains("髮型箱") || listBox1.Items[e.Index].ToString().Contains("帽子箱") || listBox1.Items[e.Index].ToString().Contains("飾品(下衣)箱") || listBox1.Items[e.Index].ToString().Contains("飾品(上衣)箱") || listBox1.Items[e.Index].ToString().Contains("皇冠箱") || listBox1.Items[e.Index].ToString().Contains("飾品(臉中)箱") || listBox1.Items[e.Index].ToString().Contains("飾品(手臂)箱")
